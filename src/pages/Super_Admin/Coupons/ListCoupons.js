    ...
    const DeleteCoupon = async (id) => {
        ...
        if (response.status == 200) {
            setConfirmDialogBox({
                isOpen: true,
                title: 'Alert',
                subTitle: "Coupon Deleted Successfully",
            })
            // M.toast({
    ...
    if (user) {
        return (
            <div>
                <div id="main">
                    <div className="row">
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col s10 m6 l6">
                                            <h5 className="breadcrumbs-title mt-0 mb-0"><span>Coupons List</span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col s3"><div className="invoice-create-btn mt-10 right pr-5">
                            <a onClick={AddCoupon} className="btn  waves-light invoice-create  z-depth-1 ">
                                            ...
                                            <div id="highlight-table" className="card card card-default scrollspy">
                                                {
                                                    ...
                                                    <MaterialTable
                                                        ...
                                                        columns={[
                                                            ...
                                                            { title: 'Coupon Percentage', field: 'coupon_percentage' },
                                                        ...
                                                        actions={[
                                                            {
                                                                icon: 'visibility',
                                                                tooltip: 'view',
                                                                onClick: (event, listRecord) => { ViewCoupon(listRecord.id) }
                                                            },
                                                            {
                                                                icon: 'create',
                                                                tooltip: 'edit',
                                                                onClick: (event, listRecord) => { EditCoupon(listRecord.id) }
                                                            },
                                                            {
                                                                icon: 'delete',
                                                                tooltip: 'delete',
                                                                onClick: (event, listRecord) => {
                                                                    setConfirmDialog({
                                                                        ...
                                                                        onConfirm: () => { DeleteCoupon(listRecord.id) }
                                                                    })
                                                                }
                                                            },
                                                        ]}
                ...
                />
                <MaxWidthDialog setConfirmDialog={setConfirmDialogBox} confirmDialog={confirmDialogBox} link={'/coupon/view'} />
            </div>
        )
    } else {
        return (null)
