      ...
      <div id="main">
        <div className="row">
                ...
                <div className="row">
                  <div className="col s10 m10 l10">
                    <h5 className="breadcrumbs-title mt-0 mb-0">
                      <span>Average Employee Compensation List</span>
                    </h5>
                  </div>
                </div>
              </div>
          ...
          <div className="col s3">
            <div className="invoice-create-btn mt-10">
              <a
                onClick={AddAverageEmp}
                className="btn  waves-light invoice-create  z-depth-1 "
              >
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <span
                                            className={
                                              item.status === "Active"
                                                ? "chip lighten-5 green green-text"
                                                : "chip lighten-5 red red-text"
                                            }
                                          >
                                            {item.status}
                                          </span>
