...
function ListYearOfExperience(props) {
    ...
    const EditYOE = (id) => {
        console.log(id)
        history.push({
            pathname: '/year_of_experience/edit',
    ...
    const AddYOE = () => {
        history.push('/year_of_experience/add')
    }
    const DeleteYOE = async (id) => {
        ...
        if (response.status == 200) {
            setConfirmDialogBox({
                isOpen: true,
                title: 'Alert',
                subTitle: "Year Of Experience Deleted Successfully",
            })
            // M.toast({
    ...
    if (user) {
        return (
            <div>
                <div id="main">
                    <div className="row">
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col s10 m6 l6">
                                            <h5 className="breadcrumbs-title mt-0 mb-0"><span>Year Of Experience List</span></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col s3"><div className="invoice-create-btn mt-10 right pr-5">
                            <a onClick={AddYOE} className="btn  waves-light invoice-create  z-depth-1 ">
                                            ...
                                            <div id="highlight-table" className="card card card-default scrollspy">
                                                {
                                                    ...
                                                    <MaterialTable
                                                        ...
                                                        style={{ padding: "20px" }}
                                                        columns={[
                                                            { title: 'Year Of Experience', field: 'year_of_experience' },
                                                        ...
                                                        actions={[
                                                            {
                                                                icon: 'visibility',
                                                                tooltip: 'view',
                                                                onClick: (event, listRecord) => { ViewYOE(listRecord.id) }
                                                            },
                                                            {
                                                                icon: 'create',
                                                                tooltip: 'edit',
                                                                onClick: (event, listRecord) => { EditYOE(listRecord.id) }
                                                            },
                                                            {
                                                                icon: 'delete',
                                                                tooltip: 'delete',
                                                                onClick: (event, listRecord) => {
                                                                    setConfirmDialog({
                                                                        ...
                                                                        onConfirm: () => { DeleteYOE(listRecord.id) }
                                                                    })
                                                                }
                                                            },
                                                        ]}
                ...
                />
                <MaxWidthDialog setConfirmDialog={setConfirmDialogBox} confirmDialog={confirmDialogBox} link={'/year_of_experience/view'} />
            </div>
        )
    } else {
        return (null)
...
export default ListYearOfExperience;