        ...
        <div id="main">
          <div className="row">
              ...
              <div className="container">
                <div className="row">
                  <div className="col s10 m6 l6">
                    <h5 className="breadcrumbs-title mt-0 mb-0"><span>Feedback Frequencies List</span></h5>
            ...
            <div className="col s3"><div className="invoice-create-btn mt-10">
              <a onClick={AddFeedback} className="btn waves-effect waves-light invoice-create  z-depth-1 ">
          ...
          <!-- data table checkbox --> */}
                                  ...
                                  <tbody>
                                    {listRecord.map((item, key) => (
                                      <tr>
                                        <td><span className="invoice-amount">{item.feedback_frequencies}</span></td>
