        ...
        <div id="main">
          <div className="row">
            ...
            <div className="col s3"><div className="invoice-create-btn mt-10 right pr-5">
              <a onClick={AddSector} className="btn waves-effect waves-light invoice-create  z-depth-1 ">
          ...
          <!-- data table checkbox --> */}
                                  ...
                                  <tbody>
                                    {listRecord.map((item, key) => (
                                      <tr>
                                        <td><span className="invoice-amount">{item.sector_name}</span></td>
